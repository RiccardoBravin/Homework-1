...
public class ListIteratorTester {
    ...
    public void setTest() {
        HList list = new ListAdapter();
        ListIteratorAdapter iter1 = new ListIteratorAdapter(list);
        assertThrows("set() non lancia IllegalStateExcpetion su una lista vuota", IllegalStateException.class, ()->{iter1.set(new Object());});
        ...
        iter2.next();
        iter2.set(obj);
        assertEquals("set() non setta correttamente l'elemento", obj, list.get(0));

        iter2.remove();
        assertThrows("set() non viene bloccato dopoi una chimata a remove()", IllegalStateException.class, ()->{iter2.set(new Object());});

        ListIteratorAdapter iter3 = new ListIteratorAdapter(list);
        iter3.add(new Object());
        assertThrows("set() non viene bloccato dopo una chiamata ad add()", IllegalStateException.class, ()->{iter3.set(new Object());});
    }
}