...
public class ListTester {
    ...
    public void addIndexTest() {
        ...
        assertEquals("add(int, Object) non aggiunge un elemento null in posizione 0/0 (objNull1)", 1, list2.size());
        ...
        assertEquals("add(int, Object) non aggiunge un elemento null in posizione 1/1  (objNull2)", 2, list2.size());
        assertEquals("add(int, Object) non contiene l'elemento inserito in posizione 1/1 (objNull2)", objNull2, list2.get(1));

        list1.add(1, obj3);
        assertEquals("add(int, Object) non aggiunge un elemento != null in posizione 1/2 (obj3)", 3, list1.size());
        assertEquals("add(int, Object) non contiene l'elemento inserito in posizione 1/2 (obj3)", obj3, list1.get(1));

        list2.add(1, objNull3);
        assertEquals("add(int, Object) non aggiunge un elemento null in posizione 1/2  (objNull3)", 3, list2.size());
        assertEquals("add(int, Object) non contiene l'elemento inserito in posizione 1/2 (objNull3)", objNull3, list2.get(1));
    }
    ...
    public void hashCodeTest() {
        ...
        notEmptyList.add(obj1);
        System.out.println(notEmptyList.hashCode());
    ...
    public void removeIndexTest() {
        ...
        assertEquals("get(int) non restituisce l'elemento corretto presente all'inizio", obj1, notEmptyList.get(0));

        assertEquals("get(int) non restituisce l'elemento corretto presente in mezzo", obj2, notEmptyList.get(2));

        assertEquals("get(int) non restituisce l'elemento corretto presente alla fine", null, notEmptyList.get(3));
    }
    ...
    public void retainAllTest() {
        ...
        assertTrue("retainAll(HCollection) non elimina tutta la lista passato come parametro una HCollection vuota", notEmptyList.retainAll(emptyCollection));
    ...
    public void subListTest() {
        ...
        ListAdapter notEmptyList = new ListAdapter();
        ListAdapter rif = new ListAdapter();
        notEmptyList.add(obj1);
        notEmptyList.add(objNull1);
        notEmptyList.add(obj2);
        notEmptyList.add(obj3);
        ...
        //Ulteriori test su file dedicato
    }
