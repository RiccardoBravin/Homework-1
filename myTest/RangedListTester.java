...
public class RangedListTester {
    ...
    public void containsTest() {
        ...
        RangedListAdapter rlist1 = new RangedListAdapter(list, 1, 3);
        assertFalse("contains(Object) trova qualcosa che non è presente nemmeno nell'intera lista", rlist1.contains(obj3));
        assertFalse("contains(Object) trova qualcosa che non è presente nella sublist ma nella lista", rlist1.contains(obj1));

        assertTrue("contains(Object) non trova un elemento !=null che è presente nella sublist", rlist1.contains(obj2));
        assertTrue("contains(Object) non trova un elemento null che è presente nella sublist", rlist1.contains(objNull));

        list.add(new Object());
        assertThrows("contains(Object) non viene invalidato da una chiamata ad add()", IllegalStateException.class, ()->{rlist.contains(null);});
    }
    ...
    public void containsAllTest() {
        ...
        RangedListAdapter rlist1 = new RangedListAdapter(list, 1, 3);
        assertFalse("containsAll() restituisce true pur non essendo presenti gli elementi nella sottolista", rlist1.containsAll(collection));
    ...
    public void equalsTest() {
        ...
        RangedListAdapter rlist2bis = new RangedListAdapter(list2, 1, 3);
        ...
        assertTrue("equals() restituisce false fra lo stesso oggetto creato da due liste diverse", rlist2bis.equals(rlist2));
    ...
    public void removeIndexTest() {
        ...
        assertEquals("remove(int) non rimuove l'elemento all'inizio", obj2, rlist1.remove(0));
        assertTrue("remove(int) ha restituito l'elemento all'inizio della subList ma non l'ha effettivamente rimosso dalla lista.", !list1.get(1).equals(obj2));          
        ...
        assertTrue("remove(int) ha restituito l'elemento in mezzo alla subList ma non l'ha effettivamente rimosso dalla lista.", list2.get(2)==null);
        ...
        assertTrue("remove(int) ha restituito l'elemento alla fine della subList ma non l'ha effettivamente rimosso dalla lista.", list3.get(3)!=null);
    ...
    public void toArrayWhitArrayTest() {
        ...
        assertThrows("non lancia NullPointerException con parametro null", NullPointerException.class, ()->{rlist1.toArray(null);});
        assertThrows("non lancia ArrayStoreException con un array troppo specializzato", ArrayStoreException.class, ()->{rlist1.toArray(new String[5]);});
