...
public class TestRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Esecuzione test LimitedListAdapterTester.class");
        Result llt = JUnitCore.runClasses(LimitedListAdapterTester.class);
        if(mt.wasSuccessful()){
            System.out.println("Esecuzione completata con successo");    
        }else{
            System.out.println("Esecuzione completata senza successo");
        ...
        //eseguire tutti i test da voi definiti, fornire almeno il risultato dei test ed il numero complessivo di test eseguiti.
    }
}
