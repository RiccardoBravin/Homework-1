...
public class HashtableKeyIteratorTester {
    @Test
    public void contructorTest() {
        Hashtable hasht = new Hashtable();

        assertNotNull("il construttore restituisce null con un hashtable vuoto", new HashTableKeyIterator(hasht));
        hasht.put(new Object(), new Object());
        assertNotNull("il construttore restituisce null con un hashtable non vuoto", new HashTableKeyIterator(hasht));
    }
    ...
    public void hasNextTest() {
        ...
        assertFalse("hasNext restituisce true su una hashtable vuota", new HashTableKeyIterator(hasht).hasNext());
        hasht.put(new Object(), new Object());
        HIterator iter = new HashTableKeyIterator(hasht);
    ...
    public void nextTest() {
        ...
        assertTrue("next() non funziona1", aux.equals(key1) || aux.equals(key2) || aux.equals(key3));
        aux = iter.next();
        assertTrue("next() non funziona2", aux.equals(key1) || aux.equals(key2) || aux.equals(key3));
        aux = iter.next();
        assertTrue("next() non funziona3", aux.equals(key1) || aux.equals(key2) || aux.equals(key3));
