...
public class EntrySetTester {
    ...
    public void removeTest() {
        ...
        map.put(key, value);
        assertTrue("remove(Object) rimuove una entry non presente", entryset.remove(entry1)==false && entryset.size()==1 && map.size()==1);
        assertTrue("remove(Object) non rimuove una entry presente", entryset.remove(entry)==true && entryset.size()==0 && map.size()==0);
    }
